...
class Public(commands.Cog):
    ...
    async def eol(self, ctx, *args):
        ...
        response_embed = discord.Embed(title=translations['eol_title'], description=translations['eol'].format(ctx.invoked_with, translations['invite_btn']))
        view = EOLButtons(ctx.bot.application_id, support_label=translations['support_btn'], invite_label=translations['invite_btn'])
